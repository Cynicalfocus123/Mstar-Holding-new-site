...
- Delivery file: `videos/business-premier-escrow-services-v3.mp4` (720x1280 H.264/yuv420p, CFR 60 FPS, silent, 3,190,726 bytes). Poster: `media/business/business-premier-escrow-services-poster-v3.webp` (73,076 bytes).
...
- Preserved the medium logo scale and kept every cluster at least as far from the white center hub; tablet and desktop positions remain unchanged.
...
- Tablet and mobile keep the existing stacked curved-image behavior, with the image now directly meeting the theme-row top line so it no longer feels detached from the boxes.
